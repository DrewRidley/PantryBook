          ...
          <nav aria-label="Sidebar" class="mt-5">
            <div class="px-2 space-y-1">
              ...
              <a href="#" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-500 mr-4 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<script>
    ...
    onMount(async () => {
        if (browser) {
            //For some reason vite gets confused with onMount and still tries to externalize libraries dynamically imported inside here.
