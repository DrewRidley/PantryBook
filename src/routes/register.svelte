...
<!--
        Use this to render the form for debugging purposes.
    ...
    <div class="bg-white py-4 px-4 shadow rounded-lg sm:px-10">
      ...
      {#if step == 0}
        <form class="space-y-6" action="#" method="POST">
          ...
          <SelectMenu
            ...
            options={[
							'Very Small (10-50 clients)',
							'Small (50-100 clients)',
							'Medium (100-250 clients)',
							'Large (250+ clients)'
						]}
          />
          <div>
      ...
      {#if step == 2}
        <form class="space-y-6">
          ...
          <div>
            <label for="invitee" class="block text-sm font-medium text-gray-700">User</label>
            <div class="flex flex-row items-center">
              <div class="mt-1 relative rounded-md shadow-sm w-9/12">
      ...
      <div class="justify-center flex">
        ...
        >
          {step != 2 ? 'Continue' : (form.invitees.length == 0 ? 'Add users later': 'Complete registration')}
        </button>
      </div>
    </div>
  </div>
