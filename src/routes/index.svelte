	...
	>
		...
		>
			...
			<form class="flex flex-col items-center w-full mb-4 md:flex-row md:px-16">
				...
				<a
					href="/"
					class="flex flex-grow w-full items-center justify-center h-12 px-6 font-semibold tracking-wide text-white transition duration-200 rounded shadow-md hover:text-gray-700 bg-indigo-500 hover:indigo-500 focus:shadow-outline focus:outline-none"
				>
					Try it for free
				</a>
			</form>
	...
	<div class="flex flex-col max-w-4xl mx-auto lg:flex-row">
		<div class="max-w-md pr-16 mx-auto mb-10">
			...
			<p class="mb-6 text-gray-900">
				With a free plan, 24/7 availability, first class mobile support and an intuitive interface, PantryBook is the one-stop-shop for
				all of your pantry management needs.
			</p>
		</div>
		<div class="grid gap-5 row-gap-5 sm:grid-cols-2">
			<div class="max-w-xl">
				...
				<p class="text-sm text-gray-700">
					Utilizing our realtime backend, PantryBook allows numerous users to enter and edit data simultaneously without complication.
				</p>
			</div>
			<div class="max-w-md">
				<div
				...
				<p class="text-sm text-gray-700">
					You'll never find yourself on a confusing export menu to simply generate reports. Easily generate pdf or excel documents with
		...
		<div class="sm:col-span-2">
			...
			<div class="mt-6 lg:max-w-sm">
				<p class="text-sm text-gray-900">
					PantryBook is a free, open sourced management software for food pantries. It offers first-class mobile support and detailed overviews to easily generate reports,
					view finances and keep track of your visitors.
				</p>
			</div>
		</div>
