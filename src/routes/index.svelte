...
<body>
		...
		>
			<div class="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
				...
				<p class="mb-6 text-base text-gray-700 md:text-lg">
					Get PantryBook today for free and see a management revolution unfold before your eyes
				</p>
	...
	<div class="px-4 py-16 mx-auto w-full md:px-24 lg:px-8 lg:py-20 bg-white">
		<div class="flex flex-col items-start max-w-screen-sm md:flex-row sm:mx-auto max-w-6xl mx-auto">
			<a class="text-blue-600 underline mb-4 mr-8" href="/">
				<div class="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-100">
					<svg stroke="currentColor" viewBox="0 0 52 52" class="w-12 h-12 text-indigo-500">
						<polygon
							stroke-width="3"
							stroke-linecap="round"
							stroke-linejoin="round"
			...
			<div>
				...
				<p class="text-base text-gray-700 md:text-lg">
					PantryBook is the pantry software that takes care of everything, so you don’t have to. We
					handle the complexity and provide you with the information you need in a quick, intuitive
					interface.
				</p>
			</div>
		</div>
		...
		<div class="flex flex-col max-w-4xl mx-auto lg:flex-row">
			<div class="max-w-md pr-16 mx-auto mb-10">
				...
				<p class="mb-6 text-gray-900">
					With a free plan, 24/7 availability, first class mobile support and an intuitive
					interface, PantryBook is the one-stop-shop for all of your pantry management needs.
				</p>
			</div>
			<div class="grid gap-5 row-gap-5 sm:grid-cols-2">
				<div class="max-w-xl">
					...
					<h6 class="mb-2 font-semibold leading-5 text-gray-900">Realtime collaboration</h6>
					<p class="text-sm text-gray-700">
						Utilizing our realtime backend, PantryBook allows numerous users to enter and edit data
						simultaneously without complication.
					</p>
				</div>
				<div class="max-w-md">
					<div class="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-100">
					...
					<h6 class="mb-2 font-semibold leading-5 text-gray-900">Effortless Reports.</h6>
					<p class="text-sm text-gray-700">
						You'll never find yourself on a confusing export menu to simply generate reports. Easily
						generate pdf or excel documents with only the data you need.
					</p>
				</div>
			</div>
		</div>
	...
	<!-- Begin footer -->
	<div class="bg-gray-100 px-4 pt-16 mx-auto w-full border-opacity-10 md:px-24 lg:px-8">
		<div class="max-w-6xl mx-auto grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
			<div class="sm:col-span-2">
				<a href="/" aria-label="Go home" title="Company" class="inline-flex items-center">
					...
					<span class="ml-2 text-xl font-bold tracking-wide text-gray-900 uppercase">Company</span>
				</a>
				<div class="mt-6 lg:max-w-sm">
					<p class="text-sm text-gray-900">
						PantryBook is a free, open sourced management software for food pantries. It offers
						first-class mobile support and detailed overviews to easily generate reports, view
						finances and keep track of your visitors.
					</p>
				</div>
			</div>
		...
		>
			<p class="text-sm text-gray-700">© Copyright 2021 PantryBook. All rights reserved.</p>
