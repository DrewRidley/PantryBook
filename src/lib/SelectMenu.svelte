		...
		{#if opened}
			<ul
				...
				{#each options as opt, i}
					<li class='text-gray-900 cursor-pointer select-none relative py-2 pl-3 pr-9' id='listbox-option-0'
							role='option'
							on:click={() => {
									selected = i;
									opened = false;
						...
						-->
						<span class='hover:text-white text-indigo-600 absolute inset-y-0 right-0 flex items-center pr-4'>
